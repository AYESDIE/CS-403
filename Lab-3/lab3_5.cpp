/**
 * Create two classes DM and DB which store the value of distances in meters
 * and centimeters.and DB in feet and inches. WAP that can read values for the
 * class objects and one object of DM to another object of DB
 */
#include <iostream>
